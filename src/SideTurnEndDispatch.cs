...
/// 饥饿和审视会永远不衰减，死神形态+ 的提前收割整份不存在。
///
/// 钻石冠冕那条也挂在同一个方法上，但写在 <see cref="RelicStatefulMirrors"/> 里跟着遗物走，
